  ...
  void _navigateToConverter(BuildContext context) {
    ...
    Navigator.of(context).push(MaterialPageRoute<Null>(
        builder: (BuildContext context) {
          return Scaffold(
            appBar: AppBar( // the ConverterRoute should also have an AppBar,
              elevation: 1.0,
              title: Text(
                name, // the title of the AppBar should be the name of the Category.
                style: Theme.of(context).textTheme.display1,
              ),
              centerTitle: true,
              backgroundColor: color, // the same color as the Category widget that was tapped.
            ),
            body: ConverterRoute( // Pass the name, color, and units to the ConverterRoute.
              color: color, 
              name: name,
              units: units,
            ),

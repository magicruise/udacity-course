...
// Add error UI, to do this, we return a null to our converter and based on that,
...
class _UnitConverterState extends State<UnitConverter> {
  ...
  // be more explicit and return a small JSON to the converter
  // that indicates an error code and a more detailed message.
  ...
  Widget build(BuildContext context) {
    ...
    // return a different UI for the error mode.
    // use a variable to keep track of whether there is an error state and set the UI based on that.
    // When our convert function returns a null, we’ll know that we’re in an error state.
